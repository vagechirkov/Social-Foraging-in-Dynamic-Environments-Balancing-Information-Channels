...
gamma_belief_array=(0.1 1 10)
dim_array=(5 15)  # 10 15
n_agent_array=(10)  # 20 30
target_speed_array=(0.1 0.3 0.5)
cost_priv=(0.9)  # 0.5 0.1 0.02
cost_belief=(0.1)  # 0.5 0.1 0.02
base_noise_array=(1 5)
dist_noise_scale_priv_array=(2 4 6)
target_persistence_array=(5 10 20 40)
